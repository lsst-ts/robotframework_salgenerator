*** Settings ***
Documentation    This suite builds the various interfaces for the MTReflector.
Force Tags    salgen    mtreflector
...
*** Variables ***
${subSystem}    MTReflector
${timeout}    1200s

*** Test Cases ***
Verify MTReflector XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.
    ${output}    Run Process    ls     ${SALWorkDir}/${subSystem}_*xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Be Empty    ${output.stdout}
    File Should Exist    ${SALWorkDir}/MTReflector_Commands.xml
    File Should Exist    ${SALWorkDir}/MTReflector_Events.xml

Salgen MTReflector Validate
    [Documentation]    Validate the MTReflector XML definitions.
    [Tags]    validate
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_reflectorStatus.idl

Verify MTReflector revCodes File
    [Documentation]    Ensure MTReflector_revCodes.tcl contains 1 revcode per topic.
    [Tags]    doc    
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_reflectorStatus\\) [a-z0-9]{8,}

Salgen MTReflector IDL
...
Verify MTReflector RPM Contents

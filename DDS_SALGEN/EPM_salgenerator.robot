*** Settings ***
Documentation    This suite builds the various interfaces for the EPM.
Force Tags    salgen    epm
...
*** Test Cases ***
Verify EPM XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.
    ${output}    Run Process    ls     ${SALWorkDir}/${subSystem}_*xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Be Empty    ${output.stdout}
    File Should Exist    ${SALWorkDir}/EPM_Telemetry.xml

Salgen EPM Validate
    [Documentation]    Validate the EPM XML definitions.
    [Tags]    validate
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_scheiderPm5xxx.idl
...
Verify EPM revCodes File
    [Documentation]    Ensure EPM_revCodes.tcl contains 1 revcode per topic.
    [Tags]    doc    
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_scheiderPm5xxx\\) [a-z0-9]{8,}

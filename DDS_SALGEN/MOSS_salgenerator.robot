*** Settings ***
Documentation    This suite builds the various interfaces for the MOSS.
Force Tags    salgen    moss
...
*** Test Cases ***
Verify MOSS XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.
    ${output}    Run Process    ls     ${SALWorkDir}/${subSystem}_*xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Be Empty    ${output.stdout}
    File Should Exist    ${SALWorkDir}/MOSS_Commands.xml
    File Should Exist    ${SALWorkDir}/MOSS_Events.xml

Salgen MOSS Validate
    [Documentation]    Validate the MOSS XML definitions.
    [Tags]    validate
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_command_moveBeam.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_command_runPulsedBeam.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_command_stopPulsedBeam.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_command_insertFlipAttenuator.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_command_removeFlipAttenuator.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_command_powerOff.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_command_powerOn.idl
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_beamIntensity.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_pulseLength.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_pulseFrequency.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_beamState.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_flipAttenuatorState.idl

Verify MOSS revCodes File
    [Documentation]    Ensure MOSS_revCodes.tcl contains 1 revcode per topic.
    [Tags]    doc    
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_command_moveBeam\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_command_runPulsedBeam\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_command_stopPulsedBeam\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_command_insertFlipAttenuator\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_command_removeFlipAttenuator\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_command_powerOff\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_command_powerOn\\) [a-z0-9]{8,}
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_beamIntensity\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_pulseLength\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_pulseFrequency\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_beamState\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_flipAttenuatorState\\) [a-z0-9]{8,}

...
Verify PromptProcessing XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/PromptProcessing_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="PromptProcessing has no XML defintions"    values=False

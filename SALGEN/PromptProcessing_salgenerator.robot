...
Verify PromptProcessing XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/PromptProcessing_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="PromptProcessing has no XML defintions"    values=False

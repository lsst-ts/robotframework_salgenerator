...
Salgen ATPtg Validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_mountPositions.json/
...
Verify ATPtg C++ Telemetry Interfaces
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/${subSystem}_mountPositions.hh
...
Verify ATPtg RPM Contents
    ...
    Should Contain    ${output.stdout}    /opt/lsst/ts_sal/avro-templates/${subSystem}/${subSystem}_mountPositions.json
    ...
    Should Contain    ${output.stdout}    /opt/lsst/ts_sal/include/${subSystem}_mountPositions.hh

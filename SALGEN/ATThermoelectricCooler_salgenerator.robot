...
Verify ATThermoelectricCooler XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/ATThermoelectricCooler_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="ATThermoelectricCooler has no XML defintions"    values=False

...
Verify ATThermoelectricCooler revCodes File
    [Documentation]    Ensure ATThermoelectricCooler_revCodes.tcl contains 1 revcode per topic.
    [Tags]    html    
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_hardwareWarning\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_temperatureReached\\) [a-z0-9]{8,}
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_fansSpeed\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_unitUpTime\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_temperatureSensors\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_processFlow\\) [a-z0-9]{8,}

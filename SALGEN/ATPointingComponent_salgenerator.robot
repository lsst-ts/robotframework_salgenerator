*** Settings ***
Documentation    This suite builds the various interfaces for the ATPointingComponent.
Force Tags    salgen    
...
*** Variables ***
${subSystem}    ATPointingComponent
${timeout}    1200s

*** Test Cases ***
Verify ATPointingComponent XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.

Salgen ATPointingComponent Validate
    [Documentation]    Validate the ATPointingComponent XML definitions.
    [Tags]
...
Salgen ATPointingComponent HTML
...
Salgen ATPointingComponent Python
...
Salgen ATPointingComponent LabVIEW
...
Salgen ATPointingComponent Java
...
Salgen ATPointingComponent Lib
...
Salgen ATPointingComponent Maven

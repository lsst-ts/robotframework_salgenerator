...
Verify MTLaserTracker XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/MTLaserTracker_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="MTLaserTracker has no XML defintions"    values=False

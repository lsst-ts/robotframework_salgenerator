*** Settings ***
Documentation    This suite builds the various interfaces for the MTLaserTracker.
Force Tags    salgen    
...
*** Test Cases ***
Verify MTLaserTracker XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.
    ${output}    Run Process    ls     ${SALWorkDir}/MTLaserTracker_*.xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Contain    ${output.stderr}    No such file or directory    msg="MTLaserTracker has no XML defintions"    values=False
    Should Not Be Empty    ${output.stdout}
    File Should Exist    ${SALWorkDir}/MTLaserTracker_Events.xml
    File Should Exist    ${SALWorkDir}/MTLaserTracker_Telemetry.xml

Salgen MTLaserTracker Validate
    [Documentation]    Validate the MTLaserTracker XML definitions.
    [Tags]    validate
...
Salgen MTLaserTracker HTML
    ...
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/html/${subSystem}/MTLaserTracker_Events.html
    File Should Exist    ${SALWorkDir}/html/${subSystem}/MTLaserTracker_Telemetry.html
    File Should Exist    ${SALWorkDir}/idl-templates/validated/${subSystem}_revCodes.tcl

Verify MTLaserTracker revCodes File
    [Documentation]    Ensure MTLaserTracker_revCodes.tcl contains 1 revcode per topic.
    [Tags]    html    
...
Verify MTLaserTracker Telemetry directories
    [Tags]    cpp
...
Verify MTLaserTracker C++ Telemetry Interfaces
...
Verify MTLaserTracker C++ Event Interfaces
    [Documentation]    Verify the C++ interfaces were properly created.
    [Tags]    cpp
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_detailedState_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_detailedState_log

Salgen MTLaserTracker Python
...
Verify MTLaserTracker Python Telemetry Interfaces
...
Verify MTLaserTracker Python Event Interfaces
    [Documentation]    Verify the Python interfaces were properly created.
    [Tags]    python
    @{files}=    List Directory    ${SALWorkDir}/${subSystem}/python    pattern=*${subSystem}*
    Log Many    @{files}

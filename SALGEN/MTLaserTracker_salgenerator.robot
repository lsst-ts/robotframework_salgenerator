...
Verify MTLaserTracker XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/MTLaserTracker_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="MTLaserTracker has no XML defintions"    values=False

...
Verify MTHeaderService XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/MTHeaderService_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="MTHeaderService has no XML defintions"    values=False

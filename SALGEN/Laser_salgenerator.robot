*** Settings ***
Documentation    This suite builds the various interfaces for the Laser.
Force Tags    salgen    
...
*** Test Cases ***
Verify Laser XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.

Salgen Laser Validate
    [Documentation]    Validate the Laser XML definitions.
    [Tags]

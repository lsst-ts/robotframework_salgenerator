...
Verify MTMount XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/MTMount_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="MTMount has no XML defintions"    values=False

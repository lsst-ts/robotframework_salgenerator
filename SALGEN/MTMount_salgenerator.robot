...
Salgen MTMount Validate
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_elevationLimitPositions.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_azimuthLimitPositions.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_cameraCableWrapLimitPositions.idl
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_deployablePlatformMotionState.idl
...
Verify MTMount revCodes File
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_elevationLimitPositions\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_azimuthLimitPositions\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_cameraCableWrapLimitPositions\\) [a-z0-9]{8,}
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_deployablePlatformMotionState\\) [a-z0-9]{8,}
...
Verify MTMount C++ Event Interfaces
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_elevationLimitPositions_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_elevationLimitPositions_log
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_azimuthLimitPositions_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_azimuthLimitPositions_log
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_cameraCableWrapLimitPositions_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_cameraCableWrapLimitPositions_log
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_deployablePlatformMotionState_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_deployablePlatformMotionState_log

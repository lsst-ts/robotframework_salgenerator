...
Verify ATBuilding XML Defintions exist
    ...
    ${output}    Run Process    ls     ${SALWorkDir}/ATBuilding_*.xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Contain    ${output.stderr}    No such file or directory    msg="ATBuilding has no XML defintions"    values=False
...
Salgen ATBuilding HTML
    ...
    File Should Exist    ${SALWorkDir}/html/${subSystem}/ATBuilding_Events.html
    File Should Exist    ${SALWorkDir}/html/${subSystem}/ATBuilding_Telemetry.html
    ...
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATBuilding_timestamp-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATBuilding_timestamp-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATBuilding_loopTime-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATBuilding_loopTime-streamdef.html
...
Verify ATBuilding Telemetry directories
    [Tags]    cpp
...
Verify ATBuilding C++ Telemetry Interfaces
...
Verify ATBuilding C++ Event Interfaces
    [Documentation]    Verify the C++ interfaces were properly created.
    [Tags]    cpp
...
Verify ATBuilding Python Telemetry Interfaces
...
Verify ATBuilding Python Event Interfaces
    [Documentation]    Verify the Python interfaces were properly created.
    [Tags]    python
    @{files}=    List Directory    ${SALWorkDir}/${subSystem}/python    pattern=*${subSystem}*
    Log Many    @{files}

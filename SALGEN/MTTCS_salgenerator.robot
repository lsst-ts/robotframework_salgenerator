...
Verify MTTCS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/MTTCS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="MTTCS has no XML defintions"    values=False

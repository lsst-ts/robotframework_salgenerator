...
Verify GCHeaderService XML Defintions exist
    ...
    File Should Exist    ${SALWorkDir}/GCHeaderService_Events.xml
...
Verify GCHeaderService revCodes File
    [Documentation]    Ensure GCHeaderService_revCodes.tcl contains 1 revcode per topic.
    [Tags]    doc    

...
Verify PointingComponent revCodes File
    [Documentation]    Ensure PointingComponent_revCodes.tcl contains 1 revcode per topic.
    [Tags]    html    
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_logevent_azWrapAlarm\\) [a-z0-9]{8,}

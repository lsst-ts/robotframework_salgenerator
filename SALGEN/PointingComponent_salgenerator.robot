...
Verify PointingComponent XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/PointingComponent_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="PointingComponent has no XML defintions"    values=False

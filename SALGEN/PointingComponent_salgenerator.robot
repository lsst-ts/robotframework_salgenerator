...
Verify PointingComponent XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/PointingComponent_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="PointingComponent has no XML defintions"    values=False
...
Salgen PointingComponent HTML
    ...
    Should Contain    ${output}    Added sal-generator-${subSystem}.prospectiveTargetStatus to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.currentTimesToLimits to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.currentTargetStatus to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.guidingAndOffsets to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.prospectiveTimesToLimits to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.nextTargetStatus to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.timeAndDate to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.mountStatus to form
    Should Contain    ${output}    Added sal-generator-${subSystem}.nextTimesToLimits to form
...
Salgen PointingComponent C++
    ...
    Should Contain    ${output}    SAL generator - ${SALVersion}
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_prospectiveTargetStatus.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_currentTimesToLimits.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_currentTargetStatus.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_guidingAndOffsets.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_prospectiveTimesToLimits.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_nextTargetStatus.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_timeAndDate.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_mountStatus.idl
    Should Contain    ${output}    Generating SAL CPP code for ${subSystem}_nextTimesToLimits.idl
...
Salgen PointingComponent Java
    ...
    Log    ${output}
    Should Contain    ${output}    SAL generator - ${SALVersion}
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_prospectiveTargetStatus.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_currentTimesToLimits.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_currentTargetStatus.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_guidingAndOffsets.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_prospectiveTimesToLimits.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_nextTargetStatus.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_timeAndDate.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_mountStatus.idl
    Should Contain    ${output}    Generating SAL Java code for ${subSystem}_nextTimesToLimits.idl

...
Verify Script revCodes File
    ...
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_configure) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_run) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_resume) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_setLogLevel) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_setCheckpoints) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_stop) [a-z0-9]{8,}
    ...
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_checkpoints) [a-z0-9]{8,}
    ...
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_description) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_metadata) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE(${subSystem}_state) [a-z0-9]{8,}

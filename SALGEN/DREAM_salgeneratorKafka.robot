...
Salgen DREAM Validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_temperatureControl.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_ups.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_alerts.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_errors.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_environment.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_powerSupply.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_dome.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_ups.json/

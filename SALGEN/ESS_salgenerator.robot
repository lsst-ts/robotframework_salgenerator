...
Verify ESS XML Defintions exist
    ...
    ${output}    Run Process    ls     ${SALWorkDir}/ESS_*.xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Contain    ${output.stderr}    No such file or directory    msg="ESS has no XML defintions"    values=False
...
Salgen ESS HTML
    ...
    File Should Exist    ${SALWorkDir}/html/${subSystem}/ESS_Telemetry.html
...
Salgen ESS C++
    ...
    Should Contain    ${output.stdout}    Generating SAL CPP code for ${subSystem}_temperature1Ch.idl
    Should Contain    ${output.stdout}    Generating SAL CPP code for ${subSystem}_temperature4Ch.idl
    Should Contain    ${output.stdout}    Generating SAL CPP code for ${subSystem}_temperature8Ch.idl
    Should Contain    ${output.stdout}    Generating SAL CPP code for ${subSystem}_cloudRainLight.idl
...
Verify ESS Telemetry directories
    ...
    Directory Should Exist    ${SALWorkDir}/${subSystem}_temperature1Ch
    Directory Should Exist    ${SALWorkDir}/${subSystem}_temperature4Ch
    Directory Should Exist    ${SALWorkDir}/${subSystem}_temperature8Ch
    Directory Should Exist    ${SALWorkDir}/${subSystem}_cloudRainLight
...
Verify ESS C++ Telemetry Interfaces
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}_temperature1Ch/cpp/standalone/sacpp_${subSystem}_pub
    File Should Exist    ${SALWorkDir}/${subSystem}_temperature1Ch/cpp/standalone/sacpp_${subSystem}_sub
    File Should Exist    ${SALWorkDir}/${subSystem}_temperature4Ch/cpp/standalone/sacpp_${subSystem}_pub
    File Should Exist    ${SALWorkDir}/${subSystem}_temperature4Ch/cpp/standalone/sacpp_${subSystem}_sub
    File Should Exist    ${SALWorkDir}/${subSystem}_temperature8Ch/cpp/standalone/sacpp_${subSystem}_pub
    File Should Exist    ${SALWorkDir}/${subSystem}_temperature8Ch/cpp/standalone/sacpp_${subSystem}_sub
    File Should Exist    ${SALWorkDir}/${subSystem}_cloudRainLight/cpp/standalone/sacpp_${subSystem}_pub
    File Should Exist    ${SALWorkDir}/${subSystem}_cloudRainLight/cpp/standalone/sacpp_${subSystem}_sub
...
Verify ESS Python Telemetry Interfaces
    [Documentation]    Verify the Python interfaces were properly created.
    [Tags]    python
    @{files}=    List Directory    ${SALWorkDir}/${subSystem}/python    pattern=*${subSystem}*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_airTurbulence_Publisher.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_airTurbulence_Subscriber.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_airFlow_Publisher.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_airFlow_Subscriber.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_temperature1Ch_Publisher.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_temperature1Ch_Subscriber.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_temperature4Ch_Publisher.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_temperature4Ch_Subscriber.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_temperature8Ch_Publisher.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_temperature8Ch_Subscriber.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_cloudRainLight_Publisher.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_cloudRainLight_Subscriber.py
...
Salgen ESS Java
    ...
    Should Contain    ${output.stdout}    Generating SAL Java code for ${subSystem}_temperature1Ch.idl
    Should Contain    ${output.stdout}    Generating SAL Java code for ${subSystem}_temperature4Ch.idl
    Should Contain    ${output.stdout}    Generating SAL Java code for ${subSystem}_temperature8Ch.idl
    Should Contain    ${output.stdout}    Generating SAL Java code for ${subSystem}_cloudRainLight.idl
...
Salgen ESS RPM
    ...
    File Should Exist    ${SALWorkDir}/rpmbuild/RPMS/x86_64/ts_sal_runtime-${SALVersion}${Build_Number}.x86_64.rpm
    File Should Exist    ${SALWorkDir}/rpmbuild/RPMS/x86_64/ts_sal_ATruntime-${SALVersion}${Build_Number}.x86_64.rpm

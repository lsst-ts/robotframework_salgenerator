...
Salgen ATBuilding Validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_ventGateState.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_extractionFanDriveState.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_extractionFanDriveFaultCode.json
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_extractionFan.json/

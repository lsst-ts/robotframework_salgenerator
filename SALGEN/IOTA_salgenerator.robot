...
Verify IOTA XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/IOTA_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="IOTA has no XML defintions"    values=False

...
Verify MTOFC XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/MTOFC_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="MTOFC has no XML defintions"    values=False

...
Salgen MTAOS Validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_wavefrontError.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_rejectedWavefrontError.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_degreeOfFreedom.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_rejectedDegreeOfFreedom.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_m2HexapodCorrection.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_rejectedM2HexapodCorrection.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_cameraHexapodCorrection.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_rejectedCameraHexapodCorrection.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_m1m3Correction.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_rejectedM1M3Correction.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_m2Correction.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_rejectedM2Correction.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_wepDuration.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_ofcDuration.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_m1m3BendingModes.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_m2BendingModes.json/

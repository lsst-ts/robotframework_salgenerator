...
Verify EFD XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/EFD_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="EFD has no XML defintions"    values=False

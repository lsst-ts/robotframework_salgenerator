...
Verify LinearStage XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/LinearStage_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="LinearStage has no XML defintions"    values=False

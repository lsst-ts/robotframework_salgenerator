...
Verify Sequencer XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/Sequencer_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="Sequencer has no XML defintions"    values=False

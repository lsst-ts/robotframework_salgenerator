...
Verify ATDomeTrajectory XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/ATDomeTrajectory_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="ATDomeTrajectory has no XML defintions"    values=False

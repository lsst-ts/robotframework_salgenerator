...
Verify DIMM XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/DIMM_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="DIMM has no XML defintions"    values=False

...
Verify ATAOS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/ATAOS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="ATAOS has no XML defintions"    values=False

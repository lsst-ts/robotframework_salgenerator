...
Verify DomeLWS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/DomeLWS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="DomeLWS has no XML defintions"    values=False

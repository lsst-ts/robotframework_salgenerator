...
Verify OCS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/OCS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="OCS has no XML defintions"    values=False

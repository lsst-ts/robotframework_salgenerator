...
Verify EAS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/EAS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="EAS has no XML defintions"    values=False

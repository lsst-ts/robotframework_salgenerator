...
Verify ATMonochromator XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/ATMonochromator_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="ATMonochromator has no XML defintions"    values=False

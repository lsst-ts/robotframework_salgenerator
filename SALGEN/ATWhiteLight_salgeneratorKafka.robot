...
Force Tags    salgen    atwhitelight
...
Salgen ATWhiteLight Validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_lampConnected.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_lampState.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_lampOnHours.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_chillerConnected.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_chillerAlarms.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_chillerWarnings.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_chillerWatchdog.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_shutterState.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_chillerFanSpeeds.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_chillerTemperatures.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_chillerCoolantFlow.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_chillerTECBankCurrents.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_chillerTECDrive.json/

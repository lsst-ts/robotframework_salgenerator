...
Verify ATArchiver XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/ATArchiver_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="ATArchiver has no XML defintions"    values=False

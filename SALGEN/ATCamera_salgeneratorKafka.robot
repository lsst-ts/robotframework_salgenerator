...
Salgen ATCamera Java
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_power.hh to sal_${subSystem} code fragments
    Should Contain    ${output.stdout}    Processing ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_vacuum.json
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_vacuum.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Analog_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Analog_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Aux_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Aux_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_ClkHigh_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_ClkHigh_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_ClkLow_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_ClkLow_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_DPHI_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_DPHI_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Digital_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Digital_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Fan_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Fan_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_GeneralConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_HVBias_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_HVBias_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Hameg1_DevicesConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Hameg1_PowerConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Hameg2_DevicesConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Hameg2_PowerConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Hameg3_DevicesConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Hameg3_PowerConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Keithley_DevicesConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_Keithley_PowerConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_OD_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_OD_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_OTM_I_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_OTM_V_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_PeriodicTasks_GeneralConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_PeriodicTasks_timersConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_power_StatusAggregator_GeneralConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_CryoCon_DeviceConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_CryoCon_DevicesConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_PeriodicTasks_GeneralConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_PeriodicTasks_timersConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_Pfeiffer_DeviceConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_Pfeiffer_DevicesConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_TempCCDSetPoint_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_TempCCD_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_TempColdPlate_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_TempCryoHead_LimitsConfiguration.hh to sal_${subSystem} code fragments
    ...
    Should Contain    ${output.stdout}    Adding /home/saluser/repos/ts_sal/test/${subSystem}/cpp/src/${subSystem}_logevent_ats_Vacuum_LimitsConfiguration.hh to sal_${subSystem} code fragments

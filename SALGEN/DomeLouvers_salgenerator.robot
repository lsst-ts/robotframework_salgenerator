...
Verify DomeLouvers XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/DomeLouvers_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="DomeLouvers has no XML defintions"    values=False

...
Verify EFDTransformationServer XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/EFDTransformationServer_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="EFDTransformationServer has no XML defintions"    values=False

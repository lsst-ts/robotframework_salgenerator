...
Verify EFDTransformationServer XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/EFDTransformationServer_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="EFDTransformationServer has no XML defintions"    values=False

...
Verify DomeMONCS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/DomeMONCS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="DomeMONCS has no XML defintions"    values=False

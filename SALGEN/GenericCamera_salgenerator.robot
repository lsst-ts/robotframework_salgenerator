...
Salgen GenericCamera HTML
    ...
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/GenericCamera_temperature-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/GenericCamera_temperature-streamdef.html

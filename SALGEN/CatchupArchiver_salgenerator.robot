...
Verify CatchupArchiver XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/CatchupArchiver_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="CatchupArchiver has no XML defintions"    values=False

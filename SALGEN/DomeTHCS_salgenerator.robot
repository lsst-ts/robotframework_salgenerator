...
Verify DomeTHCS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/DomeTHCS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="DomeTHCS has no XML defintions"    values=False

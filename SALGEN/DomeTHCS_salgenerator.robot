*** Settings ***
Documentation    This suite builds the various interfaces for the DomeTHCS.
Force Tags    salgen    
...
Verify DomeTHCS XML Defintions exist
    ...
    ${output}    Run Process    ls     ${SALWorkDir}/DomeTHCS_*.xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Contain    ${output.stderr}    No such file or directory    msg="DomeTHCS has no XML defintions"    values=False
...
Verify DomeTHCS revCodes File
    [Documentation]    Ensure DomeTHCS_revCodes.tcl contains 1 revcode per topic.
    [Tags]    html    

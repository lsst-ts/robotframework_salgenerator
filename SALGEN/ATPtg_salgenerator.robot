...
Salgen ATPtg HTML
    ...
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_prospectiveTargetStatus-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_prospectiveTargetStatus-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_nextTargetStatus-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_nextTargetStatus-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_currentTimesToLimits-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_currentTimesToLimits-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_currentTargetStatus-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_currentTargetStatus-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_guidingAndOffsets-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_guidingAndOffsets-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_prospectiveTimesToLimits-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_prospectiveTimesToLimits-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_timeAndDate-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_timeAndDate-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_mountStatus-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_mountStatus-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_nextTimesToLimits-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_nextTimesToLimits-streamdef.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_skyEnvironment-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATPtg_skyEnvironment-streamdef.html

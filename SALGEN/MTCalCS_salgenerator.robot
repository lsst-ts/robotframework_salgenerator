...
Verify MTCalCS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/MTCalCS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="MTCalCS has no XML defintions"    values=False

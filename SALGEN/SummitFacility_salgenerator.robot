...
Verify SummitFacility XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/SummitFacility_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="SummitFacility has no XML defintions"    values=False

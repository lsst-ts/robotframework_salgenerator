*** Settings ***
Documentation    This suite builds the various interfaces for the AOCLC.
Force Tags    salgen    
...
*** Test Cases ***
Verify AOCLC XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.

Salgen AOCLC Validate
    [Documentation]    Validate the AOCLC XML definitions.
    [Tags]

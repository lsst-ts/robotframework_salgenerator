...
Verify Watcher XML Defintions exist
    ...
    ${output}    Run Process    ls     ${SALWorkDir}/Watcher_*.xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Contain    ${output.stderr}    No such file or directory    msg="Watcher has no XML defintions"    values=False
...
Salgen Watcher HTML
    ...
    File Should Exist    ${SALWorkDir}/html/${subSystem}/Watcher_Commands.html
    File Should Exist    ${SALWorkDir}/html/${subSystem}/Watcher_Events.html
...
Verify Watcher C++ Command Interfaces
...
Verify Watcher C++ Event Interfaces
    [Documentation]    Verify the C++ interfaces were properly created.
    [Tags]    cpp
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_alarm_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_alarm_log

Salgen Watcher Python
...
Verify Watcher Python Command Interfaces
...
Verify Watcher Python Event Interfaces
    [Documentation]    Verify the Python interfaces were properly created.
    [Tags]    python
    @{files}=    List Directory    ${SALWorkDir}/${subSystem}/python    pattern=*${subSystem}*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_Event_alarm.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_EventLogger_alarm.py

Salgen Watcher LabVIEW

*** Settings ***
Documentation    This suite builds the various interfaces for the ATCalCS.
Force Tags    salgen    
...
*** Test Cases ***
Verify ATCalCS XML Defintions exist
    [Tags]
    Comment    Verify the CSC XML definition files exist.
    ${output}    Run Process    ls     ${SALWorkDir}/ATCalCS_*.xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Contain    ${output.stderr}    No such file or directory    msg="ATCalCS has no XML defintions"    values=False
    Should Not Be Empty    ${output.stdout}
    File Should Exist    ${SALWorkDir}/ATCalCS_Events.xml
    File Should Exist    ${SALWorkDir}/ATCalCS_Telemetry.xml

Salgen ATCalCS Validate
    [Documentation]    Validate the ATCalCS XML definitions.
    [Tags]    validate
...
Salgen ATCalCS HTML
    ...
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/html/${subSystem}/ATCalCS_Events.html
    File Should Exist    ${SALWorkDir}/html/${subSystem}/ATCalCS_Telemetry.html
    File Should Exist    ${SALWorkDir}/idl-templates/validated/${subSystem}_revCodes.tcl

Verify ATCalCS revCodes File
    [Documentation]    Ensure ATCalCS_revCodes.tcl contains 1 revcode per topic.
    [Tags]    html    
...
Verify ATCalCS Telemetry directories
    [Tags]    cpp
...
Verify ATCalCS C++ Telemetry Interfaces
...
Verify ATCalCS C++ Event Interfaces
    [Documentation]    Verify the C++ interfaces were properly created.
    [Tags]    cpp
...
Verify ATCalCS Python Telemetry Interfaces
...
Verify ATCalCS Python Event Interfaces
    [Documentation]    Verify the Python interfaces were properly created.
    [Tags]    python
    @{files}=    List Directory    ${SALWorkDir}/${subSystem}/python    pattern=*${subSystem}*
    Log Many    @{files}

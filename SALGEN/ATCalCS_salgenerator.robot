...
Verify ATCalCS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/ATCalCS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="ATCalCS has no XML defintions"    values=False

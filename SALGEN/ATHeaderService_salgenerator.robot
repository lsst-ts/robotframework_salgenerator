...
Verify ATHeaderService XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/ATHeaderService_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="ATHeaderService has no XML defintions"    values=False

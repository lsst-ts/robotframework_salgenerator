...
Verify FiberSpectrograph XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/FiberSpectrograph_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="FiberSpectrograph has no XML defintions"    values=False

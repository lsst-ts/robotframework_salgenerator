...
Salgen AtMCS Validate
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_detailedStateM3.idl
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_logevent_detailedStateMount.idl
...
Verify AtMCS C++ Event Interfaces
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_detailedStateM3_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_detailedStateM3_log
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_detailedStateMount_send
    File Should Exist    ${SALWorkDir}/${subSystem}/cpp/src/sacpp_${subSystem}_detailedStateMount_log
...
Verify AtMCS Python Event Interfaces
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_Event_detailedStateM3.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_EventLogger_detailedStateM3.py
    ...
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_Event_detailedStateMount.py
    File Should Exist    ${SALWorkDir}/${subSystem}/python/${subSystem}_EventLogger_detailedStateMount.py

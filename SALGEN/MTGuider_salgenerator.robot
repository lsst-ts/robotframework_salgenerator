*** Settings ***
Documentation    This suite builds the various interfaces for the MTGuider.
Force Tags    salgen    
...
Verify MTGuider XML Defintions exist
    ...
    ${output}    Run Process    ls     ${SALWorkDir}/MTGuider_*.xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Contain    ${output.stderr}    No such file or directory    msg="MTGuider has no XML defintions"    values=False
...
Verify MTGuider revCodes File
    [Documentation]    Ensure MTGuider_revCodes.tcl contains 1 revcode per topic.
    [Tags]    html    

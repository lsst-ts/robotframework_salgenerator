...
Salgen WeatherForecast Validate
    ...
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_metadata.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_hourlyTrend.idl
    File Should Exist    ${SALWorkDir}/idl-templates/${subSystem}_dailyTrend.idl
...
Verify WeatherForecast revCodes File
    [Documentation]    Ensure WeatherForecast_revCodes.tcl contains 1 revcode per topic.
    [Tags]    doc    
    ...
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_hourlyTrend\\) [a-z0-9]{8,}
    Should Match Regexp    ${output}    set REVCODE\\(${subSystem}_dailyTrend\\) [a-z0-9]{8,}

Salgen WeatherForecast IDL
...
Verify WeatherForecast RPM Contents
...
>>>>>>> faf3c7a... Added the new WeatherForecast CSC.

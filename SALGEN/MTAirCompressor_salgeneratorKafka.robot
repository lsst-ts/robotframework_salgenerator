*** Settings ***
Documentation    This suite builds the various interfaces for the MTAirCompressor.
Force Tags    salgen    mtaircompressor
...
*** Variables ***
${subSystem}    MTAirCompressor
${timeout}    1200s

*** Test Cases ***
Verify MTAirCompressor XML Defintions exist
    [Tags]    validate
    Comment    Verify the CSC XML definition files exist.
    ${output}    Run Process    ls     ${SALWorkDir}/${subSystem}_*xml    shell=True
    Log Many    ${output.stdout}    ${output.stderr}
    Should Not Be Empty    ${output.stdout}
    File Should Exist    ${SALWorkDir}/MTAirCompressor_Commands.xml
    File Should Exist    ${SALWorkDir}/MTAirCompressor_Events.xml
    File Should Exist    ${SALWorkDir}/MTAirCompressor_Telemetry.xml

Salgen MTAirCompressor Validate
    [Documentation]    Validate the MTAirCompressor XML definitions.
    [Tags]    validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_connectionStatus.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_status.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_compressorInfo.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_timerInfo.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_errors.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_warnings.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_analogData.json/

Salgen MTAirCompressor Lib
...
Verify MTAirCompressor RPM Contents

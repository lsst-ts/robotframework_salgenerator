...
Verify ATMCS XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/ATMCS_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="ATMCS has no XML defintions"    values=False

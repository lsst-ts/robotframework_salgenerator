...
Verify Test XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/Test_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="Test has no XML defintions"    values=False

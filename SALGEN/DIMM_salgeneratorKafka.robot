...
Salgen DIMM Validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_moduleStatus.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_dimmMeasurement.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_dimmData.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_sky.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_meterology.json/
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_status.json/

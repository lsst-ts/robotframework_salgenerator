...
Salgen ATHexapod HTML
    ...
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATHexapod_positionStatus-metadata.html
    File Should Exist    ${SALWorkDir}/html/salgenerator/${subSystem}/ATHexapod_positionStatus-streamdef.html

...
Verify ATSpectrograph XML Defintions exist
    ...
    ${stdout}    Run    ls ${SALWorkDir}/ATSpectrograph_*.xml 2>&1
    Should Not Contain    ${stdout}    No such file or directory    msg="ATSpectrograph has no XML defintions"    values=False

...
Verify CBP XML Defintions exist
    ...
    ${stdout}    ${stderr}=    Execute Command    ls ${SALWorkDir}/CBP_*.xml     return_stderr=True
    Should Not Contain    ${stderr}    No such file or directory    msg="CBP has no XML defintions"    values=False

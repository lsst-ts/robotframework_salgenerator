...
Force Tags    salgen    atdometrajectory
...
Verify ATDomeTrajectory XML Defintions exist
    ...
    File Should Exist    ${SALWorkDir}/ATDomeTrajectory_Commands.xml
...
Salgen ATDomeTrajectory Validate
    ...
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_algorithm.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_followingMode.json
    File Should Exist    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_logevent_telescopeVignetted.json
...
Verify ATDomeTrajectory RPM Contents
